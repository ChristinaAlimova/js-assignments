 ...
 *   5, 5  => 25
 */
const getRectangleArea = (w, h) => w * h;
 ...
 *   0    => 0
 */
const getCicleCircumference = r => 2 * 3.14159265358979323846 * r;
 ...
 *  -3, 3  => 0
 */
const getAverage = (v1, v2) => v1 / 2 + v2 / 2;
 ...
 *     0     => 0
 */
const getLastDigit = v => v.toString().slice(-1);
